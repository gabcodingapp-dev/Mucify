...
class AboutViewModel
    ...
    constructor(
                ...
                primaryLinks =
                    AboutLinkCollection.of(
                        AboutLinkUiModel(
                            ...
                            url = "https://github.com/gabcodingapp-dev/Mucify",
                        ),
                    ),
                leadDeveloper =
                    TeamMember(
                        avatarUrl = "https://avatars.githubusercontent.com/u/gabcodingapp-dev?v=4",
                        name = "Gab",
                        positionResId = R.string.about_position_lead_dev,
                        profileUrl = "https://github.com/gabcodingapp-dev",
                        links =
                            AboutLinkCollection.of(
                                AboutLinkUiModel(
                                    id = "github",
                                    iconResId = R.drawable.github,
                                    labelResId = R.string.about_content_desc_github,
                                    url = "https://github.com/gabcodingapp-dev",
                                ),
                            ),
                    ),
        ...
        private companion object {
            ...
            const val ContributorsReadMoreUrl = "https://github.com/gabcodingapp-dev/Mucify/graphs/contributors"
        }
    }
